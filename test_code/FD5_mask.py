...
def FD5_mask(lastFrame1, lastFrame2, currentFrame, video_name, frame_count, mask_root=None):
    ...
    try:
        from paths_ard100 import IMAGES2_OUT as _mask_root
    except ImportError:
        _mask_root = None
    if mask_root is None:
        mask_root = _mask_root
    if mask_root is None:
        raise RuntimeError('FD5_mask: задайте mask_root=... или создайте test_code/paths_ard100.py с IMAGES2_OUT')
    save_path = os.path.join(mask_root, video_name)
